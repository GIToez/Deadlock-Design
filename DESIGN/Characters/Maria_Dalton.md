...
- **Richard Dalton** — husband. Their dynamic is warm, familiar, teasing — clearly a couple who
  have weathered plenty together already.
...
erupts at the hotel — meaning neither of them is present for the chaos that follows. Per `AI.json`,
their fates are meant to be resolved once the Hospital chapter is written; the specific outcome is
not yet decided.
...
See `CANON.md`/`STORY_NOTES.md`. Locked: pregnant; leaves for St. Dymphna Hospital with Richard at
11:42 PM, before the outbreak reaches the lobby.

## Unresolved Ideas

- Her and Richard's specific fate at/after the hospital — reserved for whenever that chapter is
  written. Do not invent a resolution without explicit approval.
