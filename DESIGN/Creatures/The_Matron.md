...
close contact with several symptomatic children rather than industrial exposure)
**Encounter Type:** Boss (major encounter)
**Known Population:** a single named individual
...
window) of close, constant contact with multiple actively-transforming children exposed her slowly
rather than all at once. By the time Jim reaches her, she's mutated into something still
recognizably driven by the same impulse that got her there — she is still, in her own broken way,
protecting the room.
...
Still wearing a teacher's ordinary clothes, now stained and torn rather than replaced by anything
overtly monstrous — the "person, not an exotic invention" rule this design is built around. Her
arms and hands show the most advanced mutation (thickened, root-like growths along the forearms,
consistent with prolonged close physical contact/restraint of transforming children), while her
face stays the most human element in the room, per the same "person versus mutation" contrast rule
used for [The Maw](The_Maw.md) and [the Hospital Boss](Unnamed_Hospital_Boss.md). No claws or
fangs proposed — her threat should read as overwhelming strength and refusal to stop, not a
redesigned predator silhouette.
...
The Academy's whole thematic point is that ordinary civilians did exactly what they were told and
were failed anyway. The Matron takes that one step further: she's the person who *stopped* doing
what she was told — refused the registry, refused evacuation — out of the same protective impulse
that made her a good teacher, and it cost her everything anyway. She isn't a cautionary tale about
disobedience; the shelter's own compliant majority fared no better. She's what happens when someone
tries to fight the system with nothing but care and no way to actually protect anyone from Black
Vein itself.

## Open Design Gaps

- Full combat kit (health, damage, specific attacks, whether she has any ranged/area threat) not
  yet designed.
- Her name, and the names of the specific children she was protecting, are not yet decided —
  proposed to stay a working title ("The Matron," a name Jim never actually learns, consistent with
  "The Surgeon" and "The Caretaker" both being nicknames rather than confirmed identities) unless a
  future pass wants to name her.
- Whether any of the children she was protecting survive in some form, or are all already lost by
  the time Jim finds the room — not yet decided; should probably stay ambiguous/grim rather than
  resolved cleanly, consistent with the game's general approach to unresolved fates.
- No concept art yet.
